                    ...
                    DbContextOptions<PetsLostAndFoundContext>>()))
            {
                ...
                context.Animal.AddRange(
                            new Dog()
                            {
                                ...
                                Breed = "Border Collie",
                                Age = 10,
                                ImageUrl = "https://petsstorageaccount.blob.core.windows.net/pets/border_collie.jpg",
                            ...
                            new Cat()
                            {
                                ...
                                Breed = "Persian",
                                Age = 3,
                                ImageUrl = "https://petsstorageaccount.blob.core.windows.net/pets/persian.png",
                            ...
                            new Bird()
                            {
                                ...
                                ImageUrl = "https://petsstorageaccount.blob.core.windows.net/pets/parrot.jpg",
                                Age = 4,
                                Breed = "",
                                Description = "",
                                Microchipped = false,
                            ...
                            new Other()
                            {
                                ...
                                ImageUrl = "https://petsstorageaccount.blob.core.windows.net/pets/piglet.jpg",
                                Age = 9,
                                Breed = "",
                                Description = "",
                                Microchipped = false,
